      ...
      <div className="nleft flex items-center">
        ...
        <div className="flex gap-14 ml-20 ">
          {["Home", "Work", "Culture", "", "News"].map((elem, index) =>
            elem.length === 0 ? (
              <span key={index} className="w-[0.01vw] h-7 bg-zinc-600 "></span>
            ) : (
              <a key={index} className="text-sm flex items-center gap-1 hover:scale-115 transition-all duration-300" href="#">
                {index === 1 && (
                  <span
