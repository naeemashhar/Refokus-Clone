      ...
      <div className="max-w-screen-xl mx-auto py-5 flex gap-32">
        ...
        <div className="basis-1/2 flex gap-4">
          <div className="basis-1/3">
            ...
            {["Instagram","xCorp","LinkedIn"].map((item,index) => <a className="block mt-1 text-zinc-600">{item}</a>)}
          </div>

          <div className="basis-1/3">
            <h4 className="mb-8 text-zinc-500">Sitemap</h4>
            {["Home","Work","Career","Contact"].map((item,index) => <a className="block mt-1 text-zinc-300">{item}</a>)}
          </div>
          ...
          <div className="basis-1/2 flex flex-col items-end">
            ...
            <img className="w-32 mt-13" src="https://assets-global.website-files.com/5df3de8e749203dc3167a479/65369e818884afbae46a35fc_Webflow-badge.svg" alt="logo" />
          </div>
        </div>
      </div>
    </div>
